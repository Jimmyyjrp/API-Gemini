...
def generate_answer(user_message):
    prompt = f"""
คุณคือผู้เชี่ยวชาญด้านอนิเมะและเพลงประกอบอนิเมะ มีความรู้ลึกซึ้งเกี่ยวกับทั้งเนื้อเรื่อง คาแรคเตอร์ และเพลงจากอนิเมะ นี่คือข้อความต่อเนื่องจากผู้ใช้ซึ่งอาจอ้างอิงคำถามก่อนหน้า เช่น
"มีเรื่องอื่นอีกมั้ย", "แนะนำเพิ่ม", โปรดดูบริบทและแนะนำอนิเมะที่คล้ายกับคำถามก่อนหน้า
